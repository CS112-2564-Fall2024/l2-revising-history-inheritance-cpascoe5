...
public class Main {
	public static void main(String[] args) {
		...
		String description = "The Alamo";
	
		String revisedDescription = "the Alamo description";

		String citation = "https://en.wikipedia.org/wiki/Battle_of_the_Alamo";

		Date date = new Date(2, 23, 1836);

		HistoricalEvent[] array = new HistoricalEvent[2];
		array[0] = new RevisedEvent(description, new Date(3, 6, 1836), "The end of the Alamo", citation);
		array[1]= new RevisedEvent(description, date, revisedDescription, citation);
